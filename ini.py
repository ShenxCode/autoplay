...
zhunbei=op.PartOfTheScreen("准备", PHOTOPATH + "zhunbei.bmp")
shenle=op.PartOfTheScreen("神乐", PHOTOPATH + "shenle.bmp")

close_ld=op.PartOfTheScreen("雷电关闭", PHOTOPATH + "close_ld.bmp")
...
boss2=op.PartOfTheScreen("boss", PHOTOPATH + "boss2.bmp", 10)
...
kunnan=op.PartOfTheScreen("困难", PHOTOPATH + "kunnan.bmp")
xiaoguai2=op.PartOfTheScreen("小怪", PHOTOPATH + "xiaoguai2.bmp",10)
xiaoguai3=op.PartOfTheScreen("小怪", PHOTOPATH + "xiaoguai3.bmp",10)
xiaoguai4=op.PartOfTheScreen("小怪", PHOTOPATH + "xiaoguai4.bmp",10)
move_=op.PartOfTheScreen("滑动", PHOTOPATH + "swipe.bmp",10)
move_2=op.PartOfTheScreen("反向滑动", PHOTOPATH + "tansuo_move2.bmp",10)


manji=op.PartOfTheScreen("满级",PHOTOPATH+"manji.bmp")
manji2=op.PartOfTheScreen("满级",PHOTOPATH+"manji2.bmp")
qingminglong =op.PartOfTheScreen("晴明御灵龙",PHOTOPATH+"qingminglong.bmp")
qingmingtou=op.PartOfTheScreen("晴明头",PHOTOPATH+"qingmingtou.bmp")
qingminglong2=op.PartOfTheScreen("晴明龙2",PHOTOPATH+"qingming_long2.bmp")

all_ka =op.PartOfTheScreen("全部卡",PHOTOPATH+"all_ka.bmp")
n_ka =op.PartOfTheScreen("n卡",PHOTOPATH+"n_ka.bmp")
n_ka_find =op.PartOfTheScreen("选卡时为n卡",PHOTOPATH+"n_ka_find.bmp")

huakuai=op.PartOfTheScreen("滑块",PHOTOPATH+"huakuai.bmp")
gouliang_nka=op.PartOfTheScreen("狗粮n卡",PHOTOPATH+"gouliang_nka.bmp")
gouliang_nka2 =op.PartOfTheScreen("狗粮n卡",PHOTOPATH+"gouliang_nka2.bmp")
gouliang_nka3 =op.PartOfTheScreen("狗粮n卡",PHOTOPATH+"gouliang_nka3.bmp")
gouliang_nka4 =op.PartOfTheScreen("狗粮n卡",PHOTOPATH+"gouliang_nka4.bmp")
gouliang_nka5 =op.PartOfTheScreen("狗粮n卡",PHOTOPATH+"gouliang_nka5.bmp")
